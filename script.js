document.addEventListener('DOMContentLoaded', function() {
    ...
    const database = {
        "1": {
            ...
            sections: {
                ...
                "1.1": { title: "內容分析：論仁", content: `<h2>內容分析：論仁</h2><h3>仁者的心境與行為</h3><p>孔子指出，仁德的實踐並非一時之事，而是持續的狀態。他對比了三種人對「仁」的態度：</p><ul><li><b>不仁者：</b>無法長久處於貧困或安樂之中。貧困時會為非作歹，安樂時則會驕奢淫逸。</li><li><b>知者（智者）：</b>他們了解「仁」的好處，知道實行仁德對自己和社會有利，因此選擇行仁。這是一種理性的選擇。</li><li><b>仁者：</b>他們視「仁」為本性，自然而然地實踐仁德，心中安於此道。這是最高層次的境界。</li></ul><h3>仁與人生抉擇</h3><p>孔子強調，仁德是君子時刻不能離開的根本。無論在任何情況下，君子都應堅守「仁」的原則。</p><ul><li><b>富貴與貧賤：</b>君子雖然也期望富貴，厭惡貧賤，但獲取富貴或擺脫貧賤都必須依循正「道」。若需用不義手段，君子寧可安於貧賤，也不會接受不義的富貴。</li><li><b>生死抉擇：</b>孔子認為「仁」的價值超越生命。「志士仁人」在生死關頭，絕不會為了求生而損害仁義，反而會為了成全仁德而犧牲生命，即「殺身以成仁」。</li></ul><h3>實踐仁的方法</h3><p>顏淵向孔子請教如何達至「仁」，孔子給出了具體的實踐綱領：</p><ul><li><b>總綱：「克己復禮為仁」。</b>意思是约束自己的私慾，使言行舉止都符合「禮」的規範，這就是「仁」。</li><li><b>要目：「非禮勿視，非禮勿聽，非禮勿言，非禮勿動」。</b>這是「克己復禮」的具體條目，從視覺、聽覺、語言、行動四方面杜絕一切不合禮的行為。</li><li><b>關鍵：「為仁由己，而由人乎哉？」。</b>孔子強調，實踐仁德完全是出於自己的主動意願，而非受他人左右。</li></ul>` },
                "1.2": { title: "內容分析：論孝", content: `<h2>內容分析：論孝</h2><p>孔子對於「孝」的闡述，強調「孝」不僅是物質層面的供養，更核心的是內心的「敬」與行為上的「禮」。</p><h3>孝的核心：敬與禮</h3><ul><li><b>對孟懿子：</b>孔子以「無違」作答，並進一步解釋「無違」即是不違背「禮」。無論父母在生或去世，侍奉、安葬、祭祀都應依禮而行。這確立了「禮」作為孝行的最高準則。</li><li><b>對子游：</b>孔子批評當時普遍認為「能養」（能供養父母）就是孝的觀念。他以「至於犬馬，皆能有養」作比，指出如果只供養而沒有發自內心的恭敬，「不敬，何以別乎！」，這就與飼養動物沒有分別。</li></ul><h3>孝的具體行為</h3><ul><li><b>幾諫：</b>當父母有過錯時，子女應委婉地勸諫。如果父母不聽從，仍要對他們保持恭敬，不能冒犯，並要為他們憂心，但不可埋怨。</li><li><b>知父母之年：</b>必須緊記父母的年齡。一方面為他們的長壽而歡喜，另一方面也為他們年事已高而憂懼，從而更懂得珍惜和及時行孝。</li></ul>` },
                "1.3": { title: "內容分析：論君子", content: `<h2>內容分析：論君子</h2><p>「君子」是儒家思想中的理想人格。孔子從個人修養、心境胸懷、待人接物等多個角度，描繪了君子的形象，並常與「小人」作對比，使之更為鮮明。</p><h3>個人修為</h3><ul><li><b>莊重威儀：</b>「君子不重則不威；學則不固。」君子要莊重，才有威儀，所學的知識才會鞏固。</li><li><b>躬行實踐：</b>「君子恥其言而過其行。」君子以說得多、做得少為恥，強調言行一致，行動應超越言辭。</li><li><b>勇於改過：</b>「過則勿憚改。」有了過錯，不要害怕改正。</li><li><b>內省求己：</b>「君子求諸己，小人求諸人。」君子嚴格要求自己，小人則苛求他人。「內省不疚，夫何憂何懼？」君子經常自我反省，因為問心無愧，所以心中坦蕩，無憂無懼。</li></ul><h3>心境胸懷</h3><ul><li><b>坦蕩與憂戚：</b>「君子坦蕩蕩，小人長戚戚。」君子心胸寬廣舒泰，小人則經常憂愁不安。</li><li><b>憂慮的焦點：</b>「君子病無能焉，不病人之不己知也。」君子只擔憂自己沒有能力，而不擔心別人不了解自己，體現了專注自我提升的價值觀。</li></ul><h3>待人處事</h3><ul><li><b>交友原則：</b>「主忠信。無友不如己者。」君子以忠信為主要原則，不與品德不如自己的人交朋友。</li><li><b>成人之美：</b>「君子成人之美，不成人之惡。小人反是。」君子成全別人的好事，不促成別人的壞事，小人則相反。</li><li><b>行事準則：</b>「君子義以為質，禮以行之，孫以出之，信以成之。」君子以「義」為根本，用「禮」來實行，用謙遜的言辭說出，用誠實的態度完成。</li></ul>` },
                "1.4": { title: "仁、孝、君子的關係", content: `<h2>仁、孝、君子的關係</h2><p>「仁」、「孝」、「君子」是《論語》中三個緊密相連的核心概念，構成一個完整的道德體系。</p><ul><li><b>「孝」是「仁」的根本：</b>儒家認為「孝悌也者，其為仁之本與！」孝順父母、尊敬兄長是仁德的基礎。一個人如果能處理好家庭內部的人倫關係，才能將這份愛推己及人，擴展至社會，達至「仁」的境界。</li><li><b>「仁」是「君子」的最高追求：</b>「君子」是儒家的理想人格，而「仁」則是君子必須具備的最高道德品質。「君子去仁，惡乎成名？」君子一旦離開了「仁」，就不能稱其為君子。因此，君子的所有修為，最終都是為了達致「仁」的境界。</li><li><b>「君子」是「仁」的實踐者：</b>君子的言行標準，如「克己復禮」、「求諸己」、「成人之美」等，本身就是實踐「仁」的具體表現。「殺身成仁」更是將君子實踐仁德推向了極致。</li></ul><p>總結而言，<b>孝 → 仁 → 君子</b> 是一個由內而外、由己及人、由基礎到昇華的道德實踐過程。由孝出發，培養仁愛之心，最終成為一個在各方面都符合道德規範的君子。</p>` },
                "1.5": { title: "修辭手法與句式", content: `<h2>修辭手法與句式</h2><h3>修辭手法</h3><ul><li><b>對比：</b>多處運用君子與小人的對比，如「君子坦蕩蕩，小人長戚戚」、「君子求諸己，小人求諸人」，鮮明地突顯了君子的高尚品格。</li><li><b>排比：</b>「非禮勿視，非禮勿聽，非禮勿言，非禮勿動」和「生，事之以禮；死，葬之以禮，祭之以禮」，句式整齊，語勢強勁，使論說層次分明，極具說服力。</li><li><b>反問：</b>「不敬，何以別乎？」、「君子去仁，惡乎成名？」等反問句，加強了語氣，使論點不言而喻。</li><li><b>比喻：</b>以「犬馬」比喻只供養而無敬意的孝行，生動形象，發人深省。</li></ul><h3>句式</h3><ul><li><b>判斷句：</b>多用「...者，...也」或直接用「也」作結。例如：「不仁者，不可以久處約...」、「富與貴，是人之所欲也。」</li><li><b>倒裝句：</b>例如「君子義以為質，禮以行之...」中的「義以為質」是「以義為質」的賓語前置。</li></ul>` },
    ...
    function displayFlashcards(mainId) {
        ...
        const { title, cards, themeColor } = articleFlashcards;
        let cardHTML = '';
    ...
    function performSearch() {
        ...
        for (const mainId in database) {
            for (const subId in database[mainId].sections) {
                const section = database[mainId].sections[subId];
                if (section.type === 'quiz' || section.type === 'flashcard') continue;
